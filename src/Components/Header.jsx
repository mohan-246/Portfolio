...
const Header = ({scroller , heroRef , aboutRef , contactRef , projectsRef}) => {
  return (
    ...
    >
      ...
      <a href={`mailto:sample@gmail.com`} className="overflow-hidden h-[3.5vh] w-[17vw] text-[0.9375vw] rounded-full outline outline-white hover:outline-orange-400 transition-all duration-500 ease-in-out outline-1 items-center flex  whitespace-nowrap">
